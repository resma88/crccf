                   ...
                   <div className="row row-cols-1 row-cols-md-2 g-3 g-sm-4 g-md-5 align-items-md-stretch">
                       ...
                       <div className="col order-md-2 py-2 text-truncate">
                           <h2 className="fw-bold text-dark fs-5 fs-sm-4 fs-md-3 lh-sm lh-md">
                               Our Commitment to Modern Digital Excellence
                           </h2>
                           <div className="mt-2 mt-sm-3 d-flex flex-column gap-3">
                               <p className="mb-0 fs-6 fs-sm-5 text-secondary lh-relaxed" style={{ whiteSpace: 'pre-wrap' }}>
                                  CR Cyber Crime Foundation (CRCCF) believes that technology is not just a tool—it’s a responsibility, a promise, and a bridge that connects people with better opportunities.
                               </p>
                               <p className="mb-0 fs-6 fs-sm-5 text-secondary lh-relaxed" style={{ whiteSpace: 'pre-wrap' }}>
                                When we build a digital system, we don’t just write code;
                               </p>
                               <p className="mb-0 fs-6 fs-sm-5 text-secondary lh-relaxed" style={{ whiteSpace: 'pre-wrap' }}>
          ...
          <main className="flex-grow-1 position-relative custom-pt">
            <section className="position-relative container px-4 px-sm-5 py-4 py-sm-5 py-md-5 py-lg-5">
              <nav className="text-secondary mb-3 mb-sm-4 custom-nav-text">
                ...
                <span aria-hidden="true"> &gt; </span>
                <span aria-current="page">Software Service Intro</span>
              </nav>
              ...
              <div className="row row-cols-1 row-cols-md-2 g-3 g-sm-4 g-md-5 align-items-center">
                <div>
                  <h1 className="fw-bold text-dark lh-1 custom-heading">
                    Software Service Introduction
                  </h1>
                  <p className="mt-3  lh-lg text-primary custom-paragraph" >
                   Crafting digital experiences that connect people, build trust, and empower organizations.
                  </p>
                  <div className="mt-3 d-flex flex-wrap gap-2 ">
                    <span className="px-3 py-1 custom-badge rounded-pill text-info">Digital Excellence</span>
                    <span className="px-3 py-1 custom-badge rounded-pill text-info ">Human-Centered</span>
                    <span className="px-3 py-1 custom-badge rounded-pill text-info">Innovation</span>
