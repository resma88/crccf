        ...
        <div className="d-flex flex-column flex-md-row align-items-center justify-content-between gap-4">
          <marquee className="flex-grow-1 w-100 w-md-auto fw-lighter">
            <span className="fw-bold">
              Welcome to CR Cyber Crime Foundation
            </span>{" "}
            — one of the best organizations in India. With 24/7 dedication, CR
            Cyber Crime strives to secure justice for cyber fraud victims,
          ...
          <div className="d-flex justify-content-between align-items-center p-3">
            ...
            <div className="d-none d-xl-flex align-items-center gap-4 ">
              <div className="d-flex align-items-center gap-3 ">
                ...
                <Link to="/About" className="nav-link hover-blue">
                  About Us
                </Link>
                <Link to="/Education" className="nav-link hover-blue">
                  Education
                </Link>
                <Link to="/Gallery" className="nav-link hover-blue">
                  Gallery
                </Link>
